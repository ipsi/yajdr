...
public class DieRoller extends JFrame implements ActionListener, ChangeListener, ThreadProgress
{
	...
	public DieRoller(ThreadProgress loadingScreen)
	{
		...
		// Adding a new wodGUI object to the frame, and also to a box, in case I need to add more
		// frames later.
		...
		// Adding utility objects to bottom of frame
		...
		// Adding all d20-related panels to the tabbed pane, along with tooltip text for each, and a
		// title.
		// Currently no images.
		...
		// Creating shadowrunGUI object, and adding it content pane.
		...
		// Creating and initialising gameNotes
		...
		// Adding all items to the top-level tabbed pane. Note d20 items alread exist in d20TabPane.
		gameLine.addTab("World of Darkness", /* test2 */null, g, "Dice Roller for WoD");
		...
		// adding actionlisteners that do not relate to any individual tab.
